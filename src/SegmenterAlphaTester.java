...
public class SegmenterAlphaTester {
	...
	public static void main(String[] args) 
	{
		...
		for(double i = -2; i <= 2; i+= 0.1)
		{
			...
			AIRSystem airs = new AIRSystem(i);

			// Train the system using the training image set.
			airs.train(props.getProperty("trainingPath"), false);

			// Classify all the test images.
			System.out.printf("\nAlpha %3.1f ", i);
			airs.classifyAllInFolder(props.getProperty("testingPath"), false);
		}
	}
